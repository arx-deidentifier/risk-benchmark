...
import org.deidentifier.arx.RiskBasedBenchmarkSetup.BenchmarkCriterion;
...
public class RiskBasedBenchmarkMain {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (BenchmarkDataset data : RiskBasedBenchmarkSetup.getDatasets()) {
            for (BenchmarkCriterion criterion : RiskBasedBenchmarkSetup.getCriteria()) {
    ...
    private static void anonymize(BenchmarkDataset dataset, BenchmarkCriterion criterion) throws IOException {
        Data data = RiskBasedBenchmarkSetup.getData(dataset, criterion);
        ARXConfiguration config = RiskBasedBenchmarkSetup.getConfiguration(dataset, criterion);
